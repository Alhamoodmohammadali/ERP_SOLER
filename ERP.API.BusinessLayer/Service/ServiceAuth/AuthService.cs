using ERP.API.BusinessLayer.Service.IService.IServiceAuth;
using ERP.API.DataAccessLayer;
using ERP.API.DataAccessLayer.Models.Auth;
    ...
    public class AuthService : IAuthService
    {
        ...
        public async Task<string> Register(RegisterRequestDTO registrationRequestDto)
        {
            ApplicationUser user = new()
            {
                ...
                TenantID = registrationRequestDto.TenantID,
            };
