...
{
    public class UpdateSalesProductsDTO
    {
        [Required(ErrorMessage = "SaleProductID is required.")]
        [Range(1, int.MaxValue, ErrorMessage = "SaleProductID must be a positive number.")]
