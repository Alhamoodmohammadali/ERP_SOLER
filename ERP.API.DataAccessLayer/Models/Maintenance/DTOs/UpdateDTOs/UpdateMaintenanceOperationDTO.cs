...
namespace ERP.API.DataAccessLayer.Models.Maintenance.DTOs.UpdateDTOs
{
    public class UpdateMaintenanceOperationDTO
    {
        [Required(ErrorMessage = "MaintenanceOperationID is required.")]
        [Range(1, int.MaxValue, ErrorMessage = "MaintenanceOperationID must be a positive number.")]
